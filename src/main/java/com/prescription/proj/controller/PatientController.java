...
public class PatientController {
    ...
    public String createView(@RequestParam(defaultValue = "0") Long patientId, ModelMap model) {
    ...
    public String add(@Valid @ModelAttribute(PATIENT) Patient patient, BindingResult result, ModelMap model) {
